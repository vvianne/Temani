        ...
        <div class="cards">
            ...
            <div class="card">
                ...
                <div class="content">
                    ...
                    <p>Nyeri atau ketegangan di area punggung bawah akibat pertambahan berat badan dan perubahan postur
                        tubuh.</p>
                </div>
            </div>
            <div class="card">
                ...
                <div class="content">
                    <h3>Kelelahan</h3>
                    <p>Kelelahan umum terjadi terutama pada trimester pertama akibat perubahan hormon dan peningkatan
                        kebutuhan energi tubuh.</p>
                </div>
            </div>
            <div class="card">
                ...
                <div class="content">
                    <h3>Mulas</h3>
                    <p>Rasa panas atau tidak nyaman di dada akibat asam lambung yang naik, umum terjadi karena hormon
                        kehamilan.</p>
                </div>
            </div>
            <div class="card">
                ...
                <div class="content">
                    <h3>Sembelit</h3>
                    <p>Sembelit sering terjadi saat hamil akibat hormon dan tekanan rahim. Cegah dengan serat, air
                        putih, dan bergerak aktif.</p>
                </div>
            </div>
            <div class="card">
                ...
                <div class="content">
                    ...
                    <p>Hormon kehamilan dan tekanan rahim yang membesar pada kandung kemih menyebabkan ibu hamil lebih
                        sering buang air kecil, terutama di trimester pertama dan ketiga.</p>
                </div>
            </div>
            <div class="card">
                ...
                <div class="content">
                    ...
                    <p>Fluktuasi hormon selama kehamilan dapat memengaruhi emosi ibu, sehingga sering merasa cemas,
                        mudah marah, atau sedih secara tiba-tiba.</p>
                </div>
            </div>
            <div class="card">
                ...
                <div class="content">
                    ...
                    <p>Payudara bisa terasa nyeri, sensitif, dan mulai membesar sejak awal kehamilan sebagai persiapan
                        tubuh untuk menyusui.</p>
                </div>
            </div>
        </div>
    </section>
